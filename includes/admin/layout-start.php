...
<div class="admin-app">
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
        ...
        <nav class="sidebar-nav" aria-label="Admin navigation">
            <a href="/admin/" class="sidebar-link <?= $activePage === 'dashboard' ? 'is-active' : '' ?>">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                Dashboard
            </a>
            <a href="/admin/analytics.php" class="sidebar-link <?= $activePage === 'analytics' ? 'is-active' : '' ?>">
            ...
            <a href="/admin/jobs.php" class="sidebar-link <?= $activePage === 'jobs' ? 'is-active' : '' ?>">
            ...
            <a href="/admin/users.php" class="sidebar-link <?= $activePage === 'users' ? 'is-active' : '' ?>">
            ...
            <a href="/admin/settings.php" class="sidebar-link <?= $activePage === 'settings' ? 'is-active' : '' ?>">
        ...
        <div class="sidebar-footer">
            <a href="#" class="sidebar-link sidebar-link--muted">
